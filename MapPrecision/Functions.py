...
def importdata(jobid, timecompression):
    global xFieldCentres, TRin, FieldCentres, FieldSizes, FieldSeparation, FieldSize, SystemsMatch, FieldSeparationEB, FieldSizeEB, SystemsMatchEB, Currentiteration, Weightiteration
    ...
    FieldSeparationEB = np.zeros(int(len(FieldCentres[0, :, 0, 0]) / timecompression))
    FieldSizeEB = np.zeros(int(len(FieldCentres[0, :, 0, 0]) / timecompression))
    SystemsMatchEB = np.zeros(int(len(FieldCentres[0, :, 0, 0]) / timecompression))
