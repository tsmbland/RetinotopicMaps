...
ax1.set_title('A', x=0)
ax1.plot(range(0, len(Fieldseparation) * TRin, TRin), Fieldseparation, c='k')
...
plt.xticks([TRin, 1000, 2000, 3000, 4000])

ax3 = plt.subplot2grid((2, 2), (1, 0), colspan=2)
ax3.set_title('C', x=0)
ax3.plot(range(0, len(Systemsmatch) * TRin, TRin), Systemsmatch, c='k')
